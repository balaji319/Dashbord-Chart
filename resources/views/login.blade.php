            ...
            <div class="login-panel panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="CompanyId" id="CompanyId" placeholder="Company Id" class="form-control">
                        @if ($errors->has('email'))
                    ...
                    <div class="form-group">
                        ...
                        <input type="Password" name="PersonalCode" id="PersonalCode" placeholder="PersonalCode" class="form-control">
                        @if ($errors->has('password'))
