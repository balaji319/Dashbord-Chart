...
$var_date = date("D - M. d Y", $unixTime);  ?>
  ...
  <div class="row" id="websitecallsummary">
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel" style="">
        <div class="x_title">
          <h2>Website Summary <small> </small></h2>
              ...
              <thead>
                <tr class="headings">
                  <th class="column-title" colspan="9">
                    <center> <span id="selectedMonth"></span>PUFC Website Transactions </center>
                  </th>
                </tr>
              </thead>
            </table>
  ...
  <script src="{!! asset('js/custom/custom_website.js') !!}"></script>
@endsection