...
$var_date = date("D - M. d Y", $unixTime);  ?>
              ...
              <thead>
                <tr class="headings">
                  <th class="column-title" colspan="9">
                    <center> <span id="selectedMonth"></span>PUFC Top 25 Countries Report Graph <span id="selectDate"></span> </center>
                  </th>
                </tr>
              </thead>
            </table>
  ...
  <script src="{!! asset('js/custom/custom_topcountry.js') !!}"></script>
@endsection